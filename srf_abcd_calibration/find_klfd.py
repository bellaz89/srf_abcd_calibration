...
def find_klfd(time_trace, probe_cmplx, detuning, transition_guard):
    ...
    popt, pcov = curve_fit(klfd_square,
                           time_trace[transition_guard:-transition_guard],
                           detuning[transition_guard:-transition_guard],
                           p0 = [0, -1, 0])
